...
export class RegisterCompanyComponent {
  ...
  get companyCode() { return this.form.controls.companyCode }
  get bussinesAreaId() { return this.form.controls.businessArea.controls.id }
  get bussinesAreaName() { return this.form.controls.businessArea.controls.bussinesArea }
  get description() { return this.form.controls.description }
  get website() { return this.form.controls.website }
  get socialOne() { return this.form.controls.socialNetworks.controls.socialOne }
  get socialTwo() { return this.form.controls.socialNetworks.controls.socialTwo }
  get socialThree() { return this.form.controls.socialNetworks.controls.socialThree }
  get socialFour() { return this.form.controls.socialNetworks.controls.socialFour }
  get name() { return this.form.controls.account.controls.name }
  get email() { return this.form.controls.account.controls.email }
  get password() { return this.form.controls.account.controls.password }
  get confirmPassword() { return this.form.controls.account.controls.confirmPassword }
  get mainPhone() { return this.form.controls.account.controls.mainPhone }
  get optionalPhone() { return this.form.controls.account.controls.optionalPhone }
  get zipCode() { return this.form.controls.address.controls.zipCode.controls.zipCode }
  get street() { return this.form.controls.address.controls.zipCode.controls.street }
  get area() { return this.form.controls.address.controls.zipCode.controls.area }
  get city() { return this.form.controls.address.controls.zipCode.controls.city }
  get state() { return this.form.controls.address.controls.zipCode.controls.state }
